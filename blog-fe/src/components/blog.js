    ...
    <Row>
      ...
      <Col md={4} >
        <PanelGroup defaultActiveKey="2">
          <Panel header="Recent Posts" eventKey="1">
            <ListGroup>
              <ListGroupItem href="#">How to build a Realt-Time Chat with Websockets, Go and React.</ListGroupItem>
              <ListGroupItem href="#">Generating a Headless CMS-Api with Ponzu</ListGroupItem>
              <ListGroupItem href="#">Creating a blog with React and a Headless CMS</ListGroupItem>
            </ListGroup>
          </Panel>
